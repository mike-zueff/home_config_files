function _rc_create_backup_eigengrau
{
  ...
  then
    ...
    tar --create --directory /zfs --exclude eigengrau/.git --exclude eigengrau/data eigengrau | xz --best > "${_RC_EIGENGRAU_BACKUPS_DIRECTORY}/${_RC_CURRENT_DATE_STAMP}/eigengrau.tar.xz"
