...
do
  ...
  then
    ...
    /usr/bin/notify-send --expire-time $INTERVAL_EXPIRATION_U --icon /usr/share/icons/Tango/scalable/apps/accessories-text-editor.svg "<b>Journal</b><br />Please open Journal."
  fi
