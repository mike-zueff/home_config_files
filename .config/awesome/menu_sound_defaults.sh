...
pactl set-sink-port alsa_output.pci-0000_07_00.0.analog-stereo.7 "analog-output;output-speaker"
pactl set-sink-mute alsa_output.pci-0000_07_00.0.analog-stereo.7 0
pactl set-sink-volume alsa_output.pci-0000_07_00.0.analog-stereo.7 100%
